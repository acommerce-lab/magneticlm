"""v7 Evaluation — Pure transformer. No cache, no KN, no mixing."""
...
def eval_layers(transformer, V, encoded, cfg, device):
    ...
    print(f"    [StatTransformer] PPL={ppl:.2f}  h@1={r['hit@1']:.4f}  h@5={r['hit@5']:.4f}  ({time.time()-t_s:.1f}s)")
    return {"StatTransformer": r}
