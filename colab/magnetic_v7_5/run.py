"""CLI entry for MagneticLM v7.5."""
import argparse, os, sys, types

def _bootstrap(pkg="magnetic_v7_5"):
...
def main():
    _bootstrap()
    from magnetic_v7_5.config import add_cli_args, config_from_args
    from magnetic_v7_5.runner import run_pipeline
    parser = argparse.ArgumentParser(description="MagneticLM v7.5")
    add_cli_args(parser)
